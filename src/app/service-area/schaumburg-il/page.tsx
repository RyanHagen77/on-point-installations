...
export const metadata = generatePageMetadata({
  title: 'Commercial Furniture Installer Schaumburg, IL | On Point Installations',
  ...
  canonical: `${SITE.domain}/service-area/schaumburg-il/`,
});

export default function SchaumburgServiceAreaPage() {
  return (
    <main>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumb items={[
          ...
          { name: 'Schaumburg, IL', url: '/service-area/schaumburg-il/' },
        ]} />
      ...
      <CTABlock variant="banner" heading="Serving Schaumburg & Northwest Suburbs" />
    </main>
  );
}
