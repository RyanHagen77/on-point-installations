...
export const metadata = generatePageMetadata({
  title: 'Commercial Furniture Installer Wauconda, IL | On Point Installations',
  ...
  canonical: `${SITE.domain}/service-area/wauconda-il/`,
});

export default function WaucondaServiceAreaPage() {
  return (
    <main>
      ...
      <CTABlock variant="banner" heading="Serving Wauconda & Lake County" />
    </main>
  );
}
