...
export const metadata = generatePageMetadata({
  title: 'Commercial Furniture Installer Naperville, IL | On Point Installations',
  ...
  canonical: `${SITE.domain}/service-area/naperville-il/`,
});

export default function NapervilleServiceAreaPage() {
  return (
    <main>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumb items={[
          ...
          { name: 'Naperville, IL', url: '/service-area/naperville-il/' },
        ]} />
      ...
      <CTABlock variant="banner" heading="Serving Naperville & Western Suburbs" />
    </main>
  );
}
