    ...
    <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-8">
        ...
        <div className="text-sm text-gray-600 space-y-4">
          <div>
            <h2 className="font-semibold text-[#1a3a5c] mb-1">Phone</h2>
            <a href={SITE.phoneHref} className="text-[#1a3a5c] font-bold text-lg hover:underline">{SITE.phone}</a>
          </div>
          <div>
            <h2 className="font-semibold text-[#1a3a5c] mb-1">Address</h2>
            <p>{SITE.address.street}<br />{SITE.address.city}, {SITE.address.state} {SITE.address.zip}</p>
          </div>
          <div>
            <h2 className="font-semibold text-[#1a3a5c] mb-1">Hours</h2>
